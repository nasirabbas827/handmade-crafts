...
$sql_counts = "SELECT 
                ...
                (SELECT COUNT(*) FROM users WHERE usertype = 'seller') AS total_sellers,
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo $row['total_sellers']; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo $row['total_stores']; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
